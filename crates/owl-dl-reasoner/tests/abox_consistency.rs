...
fn p1_direct_bot_is_inconsistent() {
    assert!(
        !check_consistency("p1_direct_bot"),
...
fn p2_disjoint_types_is_inconsistent() {
    assert!(
        !check_consistency("p2_disjoint_types"),
...
fn p2_disjoint_different_individuals_is_consistent() {
    assert!(
        check_consistency("p2_disjoint_different_individuals"),
...
fn p3_neg_opa_no_clash_is_consistent() {
    assert!(
        check_consistency("p3_neg_opa_no_clash"),
...
fn p3_role_hierarchy_super_neg_is_consistent() {
    ...
    assert!(
        check_consistency("p3_role_hierarchy_neg_consistent"),
...
fn p3_role_hierarchy_sub_neg_is_inconsistent() {
    ...
    assert!(
        !check_consistency("p3_role_hierarchy_neg_inconsistent"),
...
fn p4_same_then_different_is_inconsistent() {
    assert!(
        !check_consistency("p4_same_different"),
...
fn p4_same_without_different_is_consistent() {
    assert!(
        check_consistency("p4_same_without_different"),
...
fn p5_functional_distinct_witnesses_is_inconsistent() {
    assert!(
        !check_consistency("p5_functional_diff"),
...
fn p5_functional_no_different_is_consistent() {
    assert!(
        check_consistency("p5_functional_same_target"),
...
fn p6_asymmetric_two_way_is_inconsistent() {
    assert!(
        !check_consistency("p6_asymmetric"),
...
fn p6_asymmetric_one_way_is_consistent() {
    assert!(
        check_consistency("p6_asymmetric_one_way"),
...
fn p6_irreflexive_self_loop_is_inconsistent() {
    assert!(
        !check_consistency("p6_irreflexive"),
...
fn p6_irreflexive_distinct_pair_is_consistent() {
    assert!(
        check_consistency("p6_irreflexive_distinct"),
...
fn p7_range_clashes_with_assertion_is_inconsistent() {
    assert!(
        !check_consistency("p7_range_disjoint"),
...
fn p7_range_compatible_is_consistent() {
    assert!(
        check_consistency("p7_range_compatible"),

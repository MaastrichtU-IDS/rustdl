...
| `ore-15516-alchoiq` | ORE 2015 sample (`ore_ont_15516.owl` from `ontologies/external/ore2015_sample.zip`) | RDF/XML | Phase 0 soundness-net broadening: ALCHOIQ(D) with qualified cardinality, inverses, role hierarchy, and nominals in 85 classes; **HermiT reports inconsistent** — not usable for classification diff, but retained as an inconsistency-detection fixture for the soundness net. |
